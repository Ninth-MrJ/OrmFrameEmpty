...
namespace Orm.MapContext
{
    ...
    /// 医嘱查对表 - 实体类
    /// </summary>
    public partial class AdviceAuthDtlMapping : ClassMap<AdviceAuthDtl>
    {
        /// <summary>
        /// 医嘱查对表 - 实体类
        /// </summary>
        public AdviceAuthDtlMapping()
        {
            this.TableName("ADVICEAUTHDTL").Schema("orm");
            ...
            this.Column(p => p.SN).ColumnName("SN");
