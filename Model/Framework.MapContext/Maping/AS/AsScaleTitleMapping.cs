...
{
    public class AsScaleTitleMapping : ClassMap<AsScaleTitle>
    {
        public AsScaleTitleMapping()
        {
            this.TableName("AsScaleTitle").Schema("orm");
            ...
            this.Column(p => p.IsRestsSelectScore).ColumnName("ISRESTSSELECTSCORE");
