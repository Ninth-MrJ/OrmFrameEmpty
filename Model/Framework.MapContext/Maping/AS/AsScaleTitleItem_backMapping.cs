...
{
    public class AsScaleTitleItem_backMapping: ClassMap<AsScaleTitleItem_back> 
    {
        public AsScaleTitleItem_backMapping()
        {
            this.TableName("AsScaleTitleItem_back").Schema("orm");
