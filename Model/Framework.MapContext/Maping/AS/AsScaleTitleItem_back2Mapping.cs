...
{
    public class AsScaleTitleItem_back2Mapping: ClassMap<AsScaleTitleItem_back2> 
    {
        public AsScaleTitleItem_back2Mapping()
        {
            this.TableName("AsScaleTitleItem_back2").Schema("orm");
