...
namespace Orm.MapContext
{
	...
	/// 每晚记录病人费用情况 - 实体类
	/// </summary>
	public partial class InPatFeesList_jMapping: ClassMap<InPatFeesList_j>
	{   
		/// <summary>
		/// 每晚记录病人费用情况 - 实体类
		/// </summary>
		public InPatFeesList_jMapping()
		{
			this.TableName("INPATFEESLIST_J").Schema("orm");
			...
			this.Column(p =>p.LsinStatus2).ColumnName("LSINSTATUS2");
