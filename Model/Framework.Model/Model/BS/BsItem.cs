...
namespace XYHis.Model
{
    ...
    public partial class BsItem : BaseModel
    {
        ...
        private int _groupMainId;  //主组

        private int _groupSubId;  //子组
        ...
        private int _unitTakeId;  //服用单位

        private int _frequencyId;  //频率

        private int _usageId;  //用法

        private int _feeMzId;  //门诊收费类别

        private int _feeZyId;  //住院收费类别
        ...
        private int _typeGFXEId;  //公费限额类别
        ...
        private int _locationId;  //执行科室

        private int _lISCode;  //检验ID,对应CkItem.Id
        ...
        private int _groupSubId2;  //三级分组

        private DateTime _lastTime;  //输入时间

        private double _priceSub;  //一级医院价格

        private int _checkId;  //对应基本检查

        private int _nurseId;  //对应基本护理

        private int _cureId;  //对应基本治疗

        private int _drugID;  //药典ID
        ...
        private string _packageSpec;  //包装规格
        ...
        private string _operName;  //最近修改操作员

        private bool _isFirstRecommend;  //行心云:是否已经从中成药推荐界面开过药

        private string _drugEfficacy;  //行心云:药品功效

        private string _drugInstruction;  //行心云:药品说明

        private string _drugTaboos;  //行心云:药物禁忌

        private int _commonNameId;  //行心云:通用名id

        private string _commonName;  //行心云:通用名
        ...
        private bool _isDiscounts;  //行心云:是否打折

        private int _tjLocationId;  //行心云: 体检科室
        ...
        private bool _samlingType; //行心云:采样类型
        private int _businessCity;
