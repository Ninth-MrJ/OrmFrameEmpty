...
namespace Orm.Model
{
    ...
    public partial class LogFieldChanged : BaseModel
    {
        ...
        private int _operTableID;
        private string _oldValue = string.Empty;
        private string _newValue = string.Empty;
        private string _columnName = string.Empty;
        private string _operIP = string.Empty;
        private string _machineName = string.Empty;

        public LogFieldChanged()
        {
        }
        ...
        {
            get { return this._operDate; }
            set { this._operDate = value; }
        }
        ...
        public int TableNum
        {
            get { return this._tableNum; }
            set { this._tableNum = value; }
        }
        ...
        {
            get { return this._operContent; }
            set { this._operContent = value; }
        }

        /// <summary>  
        /// 操作的表的名称  
        /// </summary>  
        public string OperTableName
        {
            get { return this._operTableName; }
            set { this._operTableName = value; }
        }

        /// <summary>
        /// 操作表的ID
        /// </summary>
        public int OperTableID
        {
            get { return this._operTableID; }
            set { this._operTableID = value; }
        }
        ...
        {
            get { return this._operIP; }
            set { this._operIP = value; }
        }
