...
namespace Orm.Model
{
    ...
    public partial class BsHouse : BaseModel
    {
        ...
        private string _roomId;  //在参数IsHuRmInOne控制药房药库合二为一的时候，如果RoomId有值，就在采购入库审核的时候直接把药品出库到RoomId的药房
        ...
        /// 是否物资库
        /// </summary>
        [Collumn(HeaderName = "是否物资库", RelatedTableType = null)]
        public bool IsHouse
        {
            get { return _isHouse; }
            set { _isHouse = value; }
        ...
        /// 对应诊所
        /// </summary>
        [Collumn(HeaderName = "对应诊所", RelatedTableType = typeof(BsHospital))]
