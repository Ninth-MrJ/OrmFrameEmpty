...
namespace Ninth.RedisHelper
{
    ...
    public partial class RedisReadHelper
    {
        private static readonly string ConnectString = ConfigurationManager.ConnectionStrings["RedisReadConnection"].ToString();
        private static Lazy<ConnectionMultiplexer> _lazyConnection;
        private static readonly Object MultiplexerLock = new Object();
        private static readonly IDatabase Cache;

        static RedisReadHelper()//his:0,yun:1,share2
        {
