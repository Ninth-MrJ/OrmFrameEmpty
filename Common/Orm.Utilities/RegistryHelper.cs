...
namespace Orm.Utilities
{
    ...
    {
        /// <summary>
        /// 读取指定名称的注册表的值GetRegistryData(Registry.LocalMachine, "SOFTWARE\\TagReceiver\\Params\\SerialPort", "PortName");
        /// </summary>
        ...
        /// <summary>
        /// 向注册表中写数据SetRegistryData(Registry.LocalMachine, "SOFTWARE\\TagReceiver\\Params\\SerialPort", "PortName", portName);
        /// </summary>
        /// <param name="name"></param>
