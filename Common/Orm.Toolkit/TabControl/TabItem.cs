...
namespace Orm.Toolkit
{
    ...
    public class TabItem : System.Windows.Controls.TabItem
    {
        ...
        public bool IsShowCloseBt
        {
            get { return (bool)GetValue(IsShowCloseBtProperty); }
            set { SetValue(IsShowCloseBtProperty, value); }
        }
        public static readonly DependencyProperty IsShowCloseBtProperty = DependencyProperty.Register("IsShowCloseBt", typeof(bool), typeof(TabItem), new UIPropertyMetadata(true));
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (button != null)
            {
                button.Click += delegate
                {
                    ...
                    TabItem tabItem = this as TabItem;
