...
namespace Orm.Toolkit.Telerik.Windows.Controls.Primitives
{
    ...
    /// </summary>
    [TemplatePart(Name = RootVisualTemplatePartName, Type = typeof(Grid))]
    ...
    public class LayoutTransformControl : ContentControl
    {
        ...
        /// </remarks>
          ...
          // Hide base class property of same name
        ...
        public new static readonly DependencyProperty LayoutTransformProperty = DependencyProperty.Register(
            "LayoutTransform", typeof(Transform), typeof(LayoutTransformControl), new PropertyMetadata(LayoutTransformChanged));
        ...
        // Note: AcceptableDelta and RoundPrecision work around double arithmetic rounding issues on Silverlight.
        ...
        static LayoutTransformControl()
		{
            ...
            DefaultStyleKeyProperty.OverrideMetadata(typeof(LayoutTransformControl),
                new FrameworkPropertyMetadata(typeof(LayoutTransformControl)));
        ...
        public override void OnApplyTemplate()
        {
            ...
            // Find template parts
            _transformationPanel = GetTemplateChild(RootVisualTemplatePartName) as Grid;
            _contentPresenter = GetTemplateChild(ContentPresenterTemplatePartName) as ContentPresenter;
            _matrixTransform = new MatrixTransform();
            if (null != _transformationPanel)
            {
                _transformationPanel.RenderTransform = _matrixTransform;
            }
        ...
        private void ProcessTransform(Transform transform)
        {
            ...
            _transformation = RoundMatrix(GetTransformMatrix(transform), RoundPrecision);
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            if ((null == _transformationPanel) || (null == child))
            {
                // No content, no size
                return Size.Empty;
            }
            ...
            // Perform a mesaure on the _transformationPanel (containing Child)
            _transformationPanel.Measure(measureSize);

            // Transform DesiredSize to find its width/height
            Rect transformedDesiredRect = RectTransform(new Rect(0, 0, _transformationPanel.DesiredSize.Width, _transformationPanel.DesiredSize.Height), _transformation);
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            if (IsSizeSmaller(finalSizeTransformed, _transformationPanel.DesiredSize))
            {
                ...
                finalSizeTransformed = _transformationPanel.DesiredSize;
            }
            ...
            // Perform an Arrange on _transformationPanel (containing Child)
            _transformationPanel.Arrange(finalRect);
