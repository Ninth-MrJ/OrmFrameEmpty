...
namespace Orm.Toolkit.Telerik.Windows.Controls
{
    ...
    /// </summary>
    public class AppointmentDeleteDialogWindow : DialogWindow, IAppointmentDeleteDialogWindow
    {
        /// <summary>
        ...
        public static readonly RoutedEvent ConfirmedEvent =
            EventManager.RegisterRoutedEvent(
                ...
                typeof(AppointmentDeleteDialogWindow));

        static AppointmentDeleteDialogWindow()
        {

            CommandManager.RegisterClassCommandBinding(
          typeof(AppointmentDeleteDialogWindow), new CommandBinding(WindowCommands.Confirm, OnConfirmCommand));
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="AppointmentDeleteDialogWindow"/> class.
        /// </summary>
        public AppointmentDeleteDialogWindow()
        {
            this.DefaultStyleKey = typeof(AppointmentDeleteDialogWindow);
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.Title = LocalizationManager.GetString("DeleteItem");
        }
        ...
        {
            var window = (AppointmentDeleteDialogWindow)sender;
