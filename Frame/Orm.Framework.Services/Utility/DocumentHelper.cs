...
namespace Orm.Framework.Services.Utility
{
    public class DocumentHelper
    {
        ...
        {
            get { return DocumentHelper.currentCount; }
        }
        /// <summary>
        /// 文件总个数
        /// </summary>
        ...
        {
            get { return DocumentHelper.count; }
        }
        /// <summary>
        /// 获取目录总文件个数
        /// </summary>
        ...
        public static void GetAllFiles(string path)
        {
            ...
            DocumentHelper.count += dir.GetFiles().Length;
            foreach (DirectoryInfo di in dir.GetDirectories())
            {
                //GetAllFiles(di);
            }
            ///return Utilities.Document.Count;
        }
